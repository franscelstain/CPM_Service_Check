...
class CreateMProductsPeriodTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('m_products_period', function (Blueprint $table) {
            ...
            $table->float('amount_1day')->nullable();
            $table->float('amount_3day')->nullable();
            $table->float('amount_1month')->nullable();
            $table->float('amount_3month')->nullable();
            $table->float('amount_6month')->nullable();
            $table->float('amount_1year')->nullable();            
            $table->float('amount_3year')->nullable();            
            $table->float('amount_5year')->nullable();            
