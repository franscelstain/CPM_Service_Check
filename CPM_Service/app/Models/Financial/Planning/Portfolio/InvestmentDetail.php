...
{    
    protected $table        = 't_portfolio_investment_detail';
    protected $primaryKey   = 'investment_detail_id';
    protected $guarded      = ['investment_detail_id', 'is_active', 'created_at', 'updated_at', 'updated_by', 'updated_host'];
