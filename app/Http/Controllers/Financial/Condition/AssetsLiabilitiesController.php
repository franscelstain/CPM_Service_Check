...
class AssetsLiabilitiesController extends AppController
{
    ...
    public function __construct(FinancialRepositoryInterface $financialRepository, InvestorRepositoryInterface $investorRepository)
    {
	...
	private function assets_outstanding($type, $inv_id, $select='', $where=[])
	{
        ...
        $qry  = DB::table(DB::raw("(
                    ...
                    INNER JOIN (" . $subQuerySql . ") AS latest_data
